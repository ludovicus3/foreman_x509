module ForemanX509
  module CertificatesHelper
    ...
    def generation_actions(generation)
      ...
      buttons << link_to(_('Download Certificate'), certificate_generation_path(generation)) unless generation.certificate.nil?
      buttons << link_to(_('Download Request'), signing_request_generation_path(generation)) unless generation.request.nil?
      buttons << link_to(_('Download Key'), key_generation_path(generation)) unless generation.key.nil?
